    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 m-auto text-center">
                <div class="headding">
                    <h1>{{__('messages.partnerOneTitle')}}</h1>
                    ...
                    <article>
                        <div class="service-single-post">
                            <div class="image-area">
                                <img src="https://alsherbinylawfirm.com/wp-content/uploads/2024/06/WhatsApp-Image-2024-06-06-at-15.16.41_d0653723.jpg"  alt="القضايا المدنية - مستشارون قانونيون" >
                            ...
                            <div class="headding4">
                                <h3>{{__('messages.partnerOneTitle')}}</h3>
                                <div class="space16"></div>
                                <p>
                                    {{__('messages.partnerOneDisc')}}
                                </p>
                            </div>
                        </div>
                    </article>
        ...
        <div class="row">
                ...
                <div class="">
                    <div class="service4-box">
                        <div class="icon">
                            <img src="../assets/img/icons/service6-icon1.png" alt="القضايا العقارية - مستشارون قانونيون ">
                        </div>
                        <div class="headding">
                            <h4><a href="real-estate-issues.html">القضايا العقارية</a></h4>
                            <p>يضم مكتب سعيد الشرمي للمحاماة والاستشارات القانونية أفضل محامي عقاري في دولة الإمارات، متخ...</p>
                            <a href="real-estate-issues.html" class="learn">اقرأ أكثر <span><i class="fa-regular fa-arrow-left"></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="">
                    <div class="service4-box">
                        ...
                        <div class="headding">
                            <h4><a href="legal-representation.html">العقود والاتفاقيات</a></h4>
                            <p>نقوم بصياغة العقود والاتفاقيات القانونية بما يتماشى مع القوانين والأنظمة المحلية والدولية،...</p>
                            <a href="legal-representation.html" class="learn">اقرأ أكثر <span><i class="fa-regular fa-arrow-left"></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="">
                    <div class="service4-box">
                        ...
                        <div class="headding">
                            <h4><a href="contracts-and-agreements-issues.html">قضايا العقود والاتفاقيات</a></h4>
                            <p>نوفر خدمات التمثيل القانوني أمام المحاكم والهيئات التحكيمية في جميع أنحاء الإمارات، ونضمن...</p>
                            <a href="contracts-and-agreements-issues.html" class="learn">اقرأ أكثر <span><i class="fa-regular fa-arrow-left"></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
