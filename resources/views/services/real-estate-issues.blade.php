    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 m-auto text-center">
                <div class="headding">
                    <h1>{{ __('messages.realEstateIssues')}}</h1>

                    <div class="list-area">
                        <a href="{{ route('home') }}">{{__('messages.home')}}</a>
                        <p class="icon"><i class="fa-regular fa-angle-right"></i></p>
                        <p class="page-text">{{__('messages.realEstateIssues')}}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="single-service-post-area padding-left">
                    <article>
                        <div class="service-single-post">
                            ...
                            <div class="headding4">
                                <h3>{{__('messages.realEstateIssues')}}</h3>
                                <div class="space16"></div>
                                <p>{{__('messages.realEstateIssuesDisc')}}</p>
                            </div>
                        </div>
                    </article>
